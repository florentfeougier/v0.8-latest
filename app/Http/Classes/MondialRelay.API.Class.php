...
require_once(dirname(__FILE__).'/dto/PointRelais.dto.php');
require_once(dirname(__FILE__).'/helpers/ParcelShopHelper.Class.php');
require_once(dirname(__FILE__).'/helpers/ApiHelper.Class.php');
