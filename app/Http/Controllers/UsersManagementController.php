...
class UsersManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('manager/users')->with('success', trans('usersmanagement.createSuccess'));
    }
    ...
    public function destroy($id)
    {
        ...
        if ($user->id != $currentUser->id) {
            ...
            return redirect('manager/users')->with('success', trans('usersmanagement.deleteSuccess'));
        }
