...
class DashboardManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        return View('dashboardmanagement.show-dashboard');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($user->id != $currentUser->id) {
            ...
            return redirect('manager/orders')->with('success', trans('ordersmanagement.deleteSuccess'));
        }

        return back()->with('error', trans('ordersmanagement.deleteSelfError'));
    }
