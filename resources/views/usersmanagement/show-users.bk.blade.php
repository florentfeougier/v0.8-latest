                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                Tous les comptes utilisateurs ({{count($users)}})
                            </span>
                            ...
                            <div class="btn-group pull-right btn-group-xs">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="/manager/users/create">
                                        <i class="fa fa-fw fa-user-plus" aria-hidden="true"></i>
                                        {!! trans('usersmanagement.buttons.create-new') !!}
                                    </a>
                                    <a class="dropdown-item" href="manager/users/deleted">
                                ...
                                <tbody id="users_table">
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                {!! Form::open(array('url' => 'manager/users/' . $user->id, 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete')) !!}
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-success btn-block" href="{{ URL::to('manager/users/' . $user->id) }}" data-toggle="tooltip" title="Show">
                                                    {!! trans('usersmanagement.buttons.show') !!}
                                                </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-sm btn-info btn-block" href="{{ URL::to('manager/users/' . $user->id . '/edit') }}" data-toggle="tooltip" title="Edit">
