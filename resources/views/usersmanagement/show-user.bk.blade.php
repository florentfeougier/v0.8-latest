      ...
      <div class="col-lg-10 offset-lg-1">
        ...
        <div class="card">
          ...
          <div class="card-body">
              ...
              <div class="col-sm-4 col-md-6">
                ...
                @if ($user->profile)
                  <div class="text-center text-left-tablet mb-4">
                    ...
                    <a href="{{url("manager/users/$user->id/edit")}}" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="{{ trans('usersmanagement.editUser') }}">
            ...
            <div class="col-sm-7">
              <span data-toggle="tooltip" data-placement="top" title="{{ trans('usersmanagement.tooltips.email-user', ['user' => $user->email]) }}">
                {{$user->profile->phone_number ?? "Non renseigné"}}
              </span>
            </div>
            ...
            @endif
              ...
              <div class="col-sm-7">
                {{ $user->profile->location_address ?? 'Non renseigné' }} {{$user->profile->location_postalcode ?? "Non renseigné"}}
              </div>
            ...
            @if (count($user->orders) > 0)
              ...
              <div class="col-sm-7">
                @foreach($user->orders as $order)
                  <a class="badge badge-secondary" href="{{url("manager/orders/" .$order->id)}}">{{$order->order_id}}</a>
                @endforeach
              </div>
