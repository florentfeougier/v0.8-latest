...
<!-- Brand -->
<a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{url("compte")}}" >Compte client </a>
    ...
    <tr>
      ...
      <td>
        @if($order->payment_status == true)
          <a href="{{url("profile/" . Auth::user()->name . "/commandes/" . $order->order_id)}}" class="badge badge-pill badge-success">Validé</a> </td>
