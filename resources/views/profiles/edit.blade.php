                ...
                <div class="card-body p-0">
                    ...
                    {{ csrf_field() }}
                                ...
                                <div class="form-group has-feedback {{ $errors->has('phone_number') ? ' has-error ' : '' }}">
                                    {!! Form::label('phone_number', "Téléphone" , array('class' => 'col-12 control-label')); !!}
                                    <div class="col-12">
                                        {!! Form::text('phone_number', old('phone_number'), array('id' => 'phone_number', 'class' => 'form-control', 'placeholder' => "06.  .  .  .  ")) !!}
                                        <span class="glyphicon {{ $errors->has('phone_number') ? ' glyphicon-asterisk ' : ' glyphicon-pencil ' }} form-control-feedback" aria-hidden="true"></span>
                                ...
                                <div class="form-group has-feedback {{ $errors->has('location_address') ? ' has-error ' : '' }}">
                                    {!! Form::label('location_address', trans('profile.label-location_address') , array('class' => 'col-12 control-label')); !!}
                                    <div class="col-12">
                                        {!! Form::text('location_address', old('location_address'), array('id' => 'location_address', 'class' => 'form-control', 'placeholder' => "Ex: 1 rue de la gare")) !!}
                                        <span class="glyphicon {{ $errors->has('location_address') ? ' glyphicon-asterisk ' : ' glyphicon-pencil ' }} form-control-feedback" aria-hidden="true"></span>
                                ...
                                <div class="form-group has-feedback {{ $errors->has('location_city') ? ' has-error ' : '' }}">
                                    {!! Form::label('location_city', trans('profile.label-location_city') , array('class' => 'col-12 control-label')); !!}
                                    <div class="col-12">
                                        {!! Form::text('location_city', old('location_city'), array('id' => 'location_city', 'class' => 'form-control', 'placeholder' => 'Ex: Lyon')) !!}
                                        <span class="glyphicon {{ $errors->has('location_city') ? ' glyphicon-asterisk ' : ' glyphicon-pencil ' }} form-control-feedback" aria-hidden="true"></span>
                                ...
                                <div class="form-group has-feedback {{ $errors->has('location_postalcode') ? ' has-error ' : '' }}">
                                    {!! Form::label('location_postalcode', trans('profile.label-location_postalcode') , array('class' => 'col-12 control-label')); !!}
                                    <div class="col-12">
                                        {!! Form::text('location_postalcode', old('location_postalcode'), array('id' => 'location_postalcode', 'class' => 'form-control', 'placeholder' => '69000')) !!}
                                        <span class="glyphicon {{ $errors->has('location_postalcode') ? ' glyphicon-asterisk ' : ' glyphicon-pencil ' }} form-control-feedback" aria-hidden="true"></span>
                                ...
                                <div class="form-group has-feedback {{ $errors->has('bio') ? ' has-error ' : '' }}">
                                    {!! Form::label('bio', "Notes" , array('class' => 'col-12 control-label')); !!}
                                    <div class="col-12">
                                ...
                                <div class="margin-bottom-2 form-group has-feedback {{ $errors->has('facebook_username') ? ' has-error ' : '' }}">
