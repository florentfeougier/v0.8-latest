...
<div>
      ...
      @if(Cart::instance("$boite->slug")->count() == $boite->product_quantity)
          ...
          <div>
            <a class=" btn btn-outline-danger bg-white" style="width:100%;text-align:center;display:block;" href="{{ url("box/" . $boite->slug . "/checkout") }}">
 @auth
     Valider ma box >
@endauth
@guest
     Se connecter et valider ma box >
@endguest
            </a> 
  ...
  <div style="width:100%;">
                    <p> Vous pouvez encore sélectionner {{ $boite->product_quantity - Cart::instance("$boite->slug")->count() }} plantes.   </p> 
	...
	<section class="bgwhite p-t-55 p-b-65">
		<div class="container animated slideInUp">
			<div class="row">
              ...
              <small class="font-3">Sélectionner {{ $boite->product_quantity }} plantes en cliquant sur leur photos.</small>
...
@endforeach
 ...
 <form action="{{url("panier/$boite->slug/store")}}" method="post">
                ...
                <input type="hidden" name="quantity" value="1">
                <div class="">
                  <button type="submit" style="width:60%;" class=" text-center fontsize-1 bo-rad-23 hov1 ml-auto mr-auto text-white btn-danger">
     Ajouter
</div>
                  </button>
                </form>
