...
@section('template_title')
  Valider votre commande - {{$boite->name}}
@endsection
...
<!---------------->
    ...
    <h3 class="text-white fontsize-7 font-3 ">{{$boite->name}}</h3>
...
<div class="row mt-2">
  ...
  <div class="col-lg-12 my-2">
      <form action="{{url("orders/store_box")}}" method="post">
...
<p class="pb-3 ">
  ...
  <div class="col-lg-5 my-2">
   ...
   {{--      <div class="flex-w flex-sb-m py-3 ">
          ...
          @else
            <span class="m-text21 w-size20 w-full-sm">Adresse indiquée</span>
          @endif
 ...
 --}}
        ...
        <div class="flex-w flex-sb-m py-3">
          ...
          <span class="m-text21 w-size20 w-full-sm">{{ $boite->price }}€</span>
        </div>
        ...
        <div class="size15  trans-0-4 mb-2 mt-4">
          <!-- Button -->
            ...
            <input type="hidden" name="amount" value="{{ $boite->price }}">
