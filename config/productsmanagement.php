...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Laravel-products setting
    |--------------------------------------------------------------------------
    */

    // Products List Pagination
    'enablePagination'              => true,
    'paginateListSize'              => env('USER_LIST_PAGINATION_SIZE', 50),

    // Enable Search Products- Uses jQuery Ajax
    'enableSearchProducts'             => true,

    // Products List JS DataTables - not recommended use with pagination
