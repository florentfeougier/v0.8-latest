...
return [
    ...
    */
    ...
    'paginateListSize'              => env('ORDER_LIST_PAGINATION_SIZE', 50),

    // Enable Search Orders- Uses jQuery Ajax
    'enableSearchOrders'             => true,

    // Orders List JS DataTables - not recommended use with pagination
