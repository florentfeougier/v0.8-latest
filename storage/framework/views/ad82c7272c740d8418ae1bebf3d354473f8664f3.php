                      ...
                      <div class="col-md-8">
                          <div class="input-group">
                            ...
                            <select class="custom-select form-control" name="status" id="x">
                                ...
                                <?php if($vente->status == "closed"): ?>
                                <option value='closed' selected> Terminé</option>
                                <option value='active' > En cours</option>
                                <?php elseif($vente->status == "active"): ?>
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        ...
                        <select class="custom-select form-control"  name="show_location" id="show_location">
                            ...
                            <?php else: ?>
                            <option value=1 selected> Cacher l'adresse</option>
                            <option value=0> Afficher l'adresse</option>
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantesaddict/prod/resources/views/ventesmanagement/edit-vente.blade.php ENDPATH**/ ?>