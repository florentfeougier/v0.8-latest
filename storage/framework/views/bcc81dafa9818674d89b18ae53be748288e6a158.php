<?php $__env->startSection('template_title'); ?>
    <?php echo e($product->name); ?> - Vente de <?php echo e($vente->name); ?>
...
<!-- Product Detail -->
    ...
    <!-- breadcrumb -->
    	<div class="bread-crumb bgwhite flex-w py-4 animated bounceInLeft">
    		...
    		<a href="<?php echo e(url("ventes/$vente->slug")); ?>" class="s-text16">
    			<?php echo e($vente->name); ?>

          <span class=" mx-2">></span>
    		</a>

    		<a href="<?php echo e(url("ventes/$vente->slug#products")); ?>" class="s-text16">
    			Produits
          <span class=" mx-2">></span>
    		</a>
		...
		<div class="flex-w flex-sb ">
            ...
            <img width="60px" class="product-thumbnail" data-type='image' data-content="<?php echo e(asset("$product->picture_two")); ?>" src="<?php echo e(asset("$product->picture_two")); ?>" alt="<?php echo e($product->name); ?>" title="<?php echo e($product->name); ?>">
          <?php endif; ?>
          <?php if(!is_null($product->video)): ?>

            <img width="60px" class="product-thumbnail" data-type='video' data-content="<?php echo e(asset("$product->video")); ?>" height="60px"src="<?php echo e(asset("storage/images/play-button.png")); ?>" alt="<?php echo e($product->name); ?>">
<?php endif; ?>
                ...
                <video width="100%" height="60%" id="product-video" style="display:none;" controls width="250" autoplay loop muted>
        ...
        <?php if($vente->status == "0"): ?>
            <span class="btn btn-danger bo-rad23">La vente</span>
	...
	<!-- Relate Product -->
		<section class=" bgwhite py-4">
          ...
          <h6 class="fontsize-5 mt-2 t-center font-3">Une sélection de plantes et accéssoires</h6>
	          ...
	          <?php $__currentLoopData = $vente->products->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php if($product->id == $relatedProduct->id): ?>
						<?php else: ?>

						<div class="item-slick2 mx-4">
							<!-- Block2 -->
							<div class="block2">

								<div class="block2-img wrap-pic-w of-hidden pos-relative">

	                <img src="<?php echo e(asset("$relatedProduct->thumbnail")); ?>" alt="k">



	              <div class="block2-overlay trans-0-4">

	                <a href="<?php echo e(url("ventes/$vente->slug/produits/$relatedProduct->slug")); ?>" class="block2-btn-addwishlist hov-pointer trans-0-4">
	                  <i class="icon-wishlist icon_heart_alt" aria-hidden="false"></i>
	                  <i class="icon-wishlist icon_heart dis-none" aria-hidden="true"></i>
	                </a>

	                <a href="<?php echo e(url("ventes/$vente->slug/produits/$relatedProduct->slug")); ?>" class="text-center" style="display:block;height:100%;">
	                ...
	                <div class=" w-size1 trans-0-4">
	                    ...
	                    <a href="<?php echo e(url("fiches-entretien/$relatedProduct->slug")); ?>" class="text-center bg4 bo-rad-23 hov1 text-white btn">
	                      Fiche d'entretien
	                    </a>
								...
								<div class="block2-txt mt-2">
									<a href="<?php echo e(url("fiches-entretien/$relatedProduct->slug")); ?>"  class="badge fontsize-1 block2-name dis-block ">
										<?php echo e($relatedProduct->name); ?>


                    <?php if($product->old_price != null): ?>
                      <span class="badge badge-secondary"><del><?php echo e($product->old_price); ?>€</del> </span>
                      <span class="badge badge-success"><?php echo e($relatedProduct->price); ?>€</span>
                    <?php else: ?>
                      <span class="badge badge-secondary "><?php echo e($relatedProduct->price); ?>€</span>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantes-addict/webapp/development/v0.8-latest/resources/views/ventes/product.blade.php ENDPATH**/ ?>