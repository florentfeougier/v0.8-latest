...
<!-- Brand -->
<a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?php echo e(url("compte")); ?>" >Compte client </a>
    ...
    <tr>
      ...
      <td>
        <?php if($order->payment_status == true): ?>
          <a href="<?php echo e(url("profile/" . Auth::user()->name . "/commandes/" . $order->order_id)); ?>" class="badge badge-pill badge-success">Validé</a> </td>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantesaddict/prod/resources/views/pages/user/home.blade.php ENDPATH**/ ?>