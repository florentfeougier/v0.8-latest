...
<section class="shipping bgwhite animated bounceInUp">
  <div class="flex-w py-2 px-1">
    <div class="flex-col-c w-size5 py-4 respon1">
      <span class="text-center"> <img src="<?php echo e(url('https://image.flaticon.com/icons/svg/1670/1670020.svg')); ?>" height="60px" alt=""> </span>
    ...
    <div class="flex-col-c w-size5  py-4 respon1">
      ...
      <span class="s-text11 t-center  fontsize-2">
        <?php echo $fiche->lumiere_info; ?>

      </span>
    </div>
  </div>
</section>
<?php /**PATH /Users/florent/Dev/plantes-addict/webapp/development/v0.8-latest/resources/views/fiches/partials/features.blade.php ENDPATH**/ ?>