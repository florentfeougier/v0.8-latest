...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div>
                    <h1 class="text-center">Commandes du shop</h1>
                    <h5></h5>
                </div>
                <div id="accordion">
  <div class="card">
...
datasets: [{
label: "Shop",
data: ["<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(14))->get())); ?>","<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(13))->get())); ?>","<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(12))->get())); ?>","<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(11))->get())); ?>","<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(10))->get())); ?>","<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(9))->get())); ?>","<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(8))->get())); ?>","<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(7))->get())); ?>","<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(6))->get())); ?>","<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(5))->get())); ?>", "<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(4))->get())); ?>", "<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(3))->get())); ?>", "<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(2))->get())); ?>", "<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today()->subDays(1))->get())); ?>", "<?php echo e(count(\App\Models\Order::where('cart', 'shop')->whereDate('created_at' , \Carbon\Carbon::today())->get())); ?>"],
backgroundColor: [
'rgba(105, 0, 132, .2)',
],
borderColor: [
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantesaddict/prod/resources/views/ordersmanagement/show-orders-shop.blade.php ENDPATH**/ ?>