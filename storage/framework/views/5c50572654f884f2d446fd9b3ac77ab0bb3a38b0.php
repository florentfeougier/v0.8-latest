...
<?php if(session('success')): ?>
  <div class="alert alert-success alert-dismissable fade show" role="alert">
    ...
    <h4><i class="icon fa fa-check fa-fw" aria-hidden="true"></i> Réussi!</h4>
...
<?php /**PATH /Users/florent/Dev/plantes-addict/webapp/development/v0.8-latest/resources/views/partials/form-status.blade.php ENDPATH**/ ?>