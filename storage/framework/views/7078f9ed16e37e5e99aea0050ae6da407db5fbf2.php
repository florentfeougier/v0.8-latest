...
<a class="h5 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?php echo e(url("profile/" . Auth::user()->name . '/paiements')); ?>" >Paiements</a>
...
<div class="row">
<div class="col-lg-12">
<h1 class=" text-white">VOS PAIEMENTS (<?php echo e(count(Auth::user()->payments)); ?>)</h1>
<p class="text-white ">Bienvenue sur votre espace client. Vous pouvez voir vos paiements, retrouvez vos achats et les fiches d'entretien associés, ainsi que des astuces et un groupe d'entraide!</p>
<a href="<?php echo e(url('profile/' . Auth::user()->name . '/commandes')); ?>" class="btn btn-success">Voir vos commandes</a>
<a href="<?php echo e(url('profile/' . Auth::user()->name . '/edit')); ?>" class="btn btn-secondary">Modifier mes infos de facturation</a>
...
<div class="col-xl-8 payments-xl-1">
<div class="card shadow">
<div class="card-header bg-white bpayments-0">
<div class="row align-items-center">
<div class="col-8">
<h3 class="mb-0">Toutes vos paiements</h3>
</div>
...
<h6 class="heading-small text-muted mb-4">Voici le résumé de vos paiements</h6>
...
<div class="table-responsive">
  ...
  <tbody>
    <?php if(count($user->payments) > 0): ?>
    <?php $__currentLoopData = $user->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <th scope="row"> <a href="<?php echo e(url("profile/" . Auth::user()->name . "/paiements/" . $payments->payments_id )); ?>"><?php echo e($payments->payments_id); ?></a> </th>
      <td><?php echo e($payments->created_at); ?></td>
      <td><?php echo e($payments->amount); ?>€</td>
      <td>
        <?php if($payments->status == "payed"): ?>
          <a href="<?php echo e(url('')); ?>" class="badge badge-pill badge-success">Validé</a> </td>

        <?php else: ?>
          <a href="<?php echo e(url("compte/paiements/$payments->payments_id")); ?>" class="badge badge-pill badge-warning">Payer maintenant</a> </td>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantesaddict/prod/resources/views/pages/user/payments.blade.php ENDPATH**/ ?>