              ...
              <?php echo e(round($totalTax, 2)); ?> €
				...
				<div class="size15  trans-0-4 mb-2 mt-4">
					...
					<a href="<?php echo e(url("panier/$cartName/checkout")); ?>" class="cart-validate-btn flex-c-m py-2 bg1 text-white bo-rad-23 hov1  trans-0-4">
						VALIDER MON PANIER <img class="ml-2" src="<?php echo e(url("storage/icons/right-arrow.svg")); ?>" height="20px" alt="Cliquer ici">
					</a>
				</div>
			</div>
			<?php else: ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantes-addict/webapp/development/v0.8-latest/resources/views/carts/show.blade.php ENDPATH**/ ?>