<?php $__env->startSection('template_title'); ?>
  Valider votre commande - <?php echo e($boite->name); ?>
...
<!---------------->
	<section class="bg-title-page flex-col-c-m" style="background-image: url(<?php echo e(asset('storage/images/bg-sale.jpg')); ?>);">
		...
		<h2 class="fontsize-7 text-white font-2b my-2 t-center">VALIDER MA BOX</h2>
    <h3 class="text-white fontsize-7 font-3 "><?php echo e($boite->name); ?></h3>
...
<div class="row mt-2">
  ...
  <div class="col-lg-12 my-2">
      <form action="<?php echo e(url("orders/store_box")); ?>" method="post">
    ...
    <div class="bo9 w-size28  text-center ml-auto mr-auto">
      <h5 class="m-text20 py-4">Résumé de la commande</h5>
        ...
        <div class="flex-w flex-sb-m py-3">
          ...
          <span class="m-text21 w-size20 w-full-sm"><?php echo e($boite->price); ?>€</span>
        </div>
        ...
        <div class="size15  trans-0-4 mb-2 mt-4">
          <!-- Button -->
            ...
            <input type="hidden" name="amount" value="<?php echo e($boite->price); ?>">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantes-addict/webapp/development/v0.8-latest/resources/views/boites/checkout.blade.php ENDPATH**/ ?>