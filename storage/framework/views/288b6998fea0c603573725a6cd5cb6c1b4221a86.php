...
<html lang="<?php echo e(config('app.locale')); ?>">
    <head>
        ...
        <title><?php if(trim($__env->yieldContent('template_title'))): ?><?php echo $__env->yieldContent('template_title'); ?> | Manager | <?php endif; ?> <?php echo e(config('app.name', Lang::get('titles.app'))); ?></title>
    ...
    <body>
        <div id="app">
            ...
            <?php echo $__env->make('partials.manager-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /Users/florent/Dev/plantesaddict/prod/resources/views/layouts/admin.blade.php ENDPATH**/ ?>