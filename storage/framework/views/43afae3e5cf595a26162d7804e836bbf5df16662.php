...
<!-- Brand -->
<a class="h5 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?php echo e(url("home")); ?>" >Compte client </a>
...
<div class="row">
<div class="col-lg-12">
<h1 class="text-white">Bonjour <?php echo e(ucfirst(Auth::user()->name)); ?></h1>
...
<a href="<?php echo e(url('shop')); ?>" class="btn btn-success">Aller sur le shop</a>
<a href="<?php echo e(url('profile/' . Auth::user()->name . '/commandes')); ?>" class="btn btn-secondary">Voir mes commandes</a>
    ...
    <tr>
      ...
      <td>
        <?php if($order->status == "payed"): ?>
          <a href="<?php echo e(url("compte/paiements/$order->payment_id")); ?>" class="badge badge-pill badge-success">Validé</a> </td>

        <?php else: ?>
          <a href="<?php echo e(url("compte/commandes/$order->order_id")); ?>" class="badge badge-pill badge-warning">Payer maintenant</a> </td>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantesaddict/prod/resources/views/profiles/show.blade.php ENDPATH**/ ?>