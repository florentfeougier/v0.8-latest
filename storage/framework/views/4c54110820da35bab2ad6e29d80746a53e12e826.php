...
<section class="bg-title-page flex-col-c-m" style="background-image: url(<?php echo e(asset('storage/images/bg-sale.jpg')); ?>);">
  ...
  <span class="badge badge-secondary mt-3 ">Cette boite est terminé!</span>
  <?php else: ?>
	...
	<section class="bgwhite p-t-55 p-b-65">
		<div class="container animated slideInUp">
			<div class="row">
              ...
              <small class="font-3">Récupérez votre commande lors de la boite</small>
...
<?php endif; ?>
    				...
    				<div class="block2-overlay trans-0-4">
    					...
    					<a href="<?php echo e(url("boites/$boite->slug/produits/$product->slug")); ?>" class="text-center" style="display:block;height:100%;">
      ...
      <img src="<?php echo e(asset('storage/icons/add-to-cart.svg')); ?>" class=" ml-1" style=" width:20px;" height="20px" alt="">
          ...
          <?php else: ?>
            ...
            <?php if(\Carbon\Carbon::now() > $boite->date): ?>
              Cette boite est terminé. <a href="<?php echo e(url("boites")); ?>">Voir nos prochaines boites</a>
            <?php else: ?>
            Aucun plantes disponible pour cette boite.
            <?php endif; ?>
              </p>
            ...
            <div class="col-lg-6 mbr-col-md-10">
                <div class="wrap">
                    ...
                    <div class="text-wrap vcenter">
                        ...
                        <p class="mbr-fonts-style text1 mbr-text display-6">L'entrée est libre à tous le   <?php echo e(date('d/m/Y', strtotime($boite->date))); ?> de <?php echo e($boite->horaires); ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantesaddict/prod/resources/views/boites/show.blade.php ENDPATH**/ ?>