            ...
            <div class="card border-0">
                <div class="card-body p-0">
                    ...
                    <?php echo e(csrf_field()); ?>
                                ...
                                <div class="form-group has-feedback <?php echo e($errors->has('phone_number') ? ' has-error ' : ''); ?>">
                                    <?php echo Form::label('phone_number', "Téléphone" , array('class' => 'col-12 control-label'));; ?>

                                    <div class="col-12">
                                        <?php echo Form::text('phone_number', old('phone_number'), array('id' => 'phone_number', 'class' => 'form-control', 'placeholder' => "06.  .  .  .  ")); ?>

                                        <span class="glyphicon <?php echo e($errors->has('phone_number') ? ' glyphicon-asterisk ' : ' glyphicon-pencil '); ?> form-control-feedback" aria-hidden="true"></span>
                                ...
                                <div class="form-group has-feedback <?php echo e($errors->has('location_address') ? ' has-error ' : ''); ?>">
                                    <?php echo Form::label('location_address', trans('profile.label-location_address') , array('class' => 'col-12 control-label'));; ?>

                                    <div class="col-12">
                                        <?php echo Form::text('location_address', old('location_address'), array('id' => 'location_address', 'class' => 'form-control', 'placeholder' => "Ex: 1 rue de la gare")); ?>

                                        <span class="glyphicon <?php echo e($errors->has('location_address') ? ' glyphicon-asterisk ' : ' glyphicon-pencil '); ?> form-control-feedback" aria-hidden="true"></span>
                                ...
                                <div class="form-group has-feedback <?php echo e($errors->has('location_city') ? ' has-error ' : ''); ?>">
                                    <?php echo Form::label('location_city', trans('profile.label-location_city') , array('class' => 'col-12 control-label'));; ?>

                                    <div class="col-12">
                                        <?php echo Form::text('location_city', old('location_city'), array('id' => 'location_city', 'class' => 'form-control', 'placeholder' => 'Ex: Lyon')); ?>

                                        <span class="glyphicon <?php echo e($errors->has('location_city') ? ' glyphicon-asterisk ' : ' glyphicon-pencil '); ?> form-control-feedback" aria-hidden="true"></span>
                                ...
                                <div class="form-group has-feedback <?php echo e($errors->has('location_postalcode') ? ' has-error ' : ''); ?>">
                                    <?php echo Form::label('location_postalcode', trans('profile.label-location_postalcode') , array('class' => 'col-12 control-label'));; ?>

                                    <div class="col-12">
                                        <?php echo Form::text('location_postalcode', old('location_postalcode'), array('id' => 'location_postalcode', 'class' => 'form-control', 'placeholder' => '69000')); ?>

                                        <span class="glyphicon <?php echo e($errors->has('location_postalcode') ? ' glyphicon-asterisk ' : ' glyphicon-pencil '); ?> form-control-feedback" aria-hidden="true"></span>
                                ...
                                <div class="form-group has-feedback <?php echo e($errors->has('bio') ? ' has-error ' : ''); ?>">
                                    <?php echo Form::label('bio', "Notes" , array('class' => 'col-12 control-label'));; ?>
                                ...
                                <div class="margin-bottom-2 form-group has-feedback <?php echo e($errors->has('facebook_username') ? ' has-error ' : ''); ?>">
                                    <?php echo Form::label('facebook_username', trans('profile.label-facebook_username') , array('class' => 'col-12 control-label'));; ?>

                                    <div class="col-12">
                                        <?php echo Form::text('facebook_username', old('facebook_username'), array('id' => 'facebook_username', 'class' => 'form-control', 'placeholder' => trans('profile.ph-facebook_username'))); ?>

                                        <span class="glyphicon glyphicon-pencil form-control-feedback" aria-hidden="true"></span>
                                        <?php if($errors->has('facebook_username')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('facebook_username')); ?></strong>
                                        </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantesaddict/prod/resources/views/profiles/edit.blade.php ENDPATH**/ ?>