<?php $__env->startSection('template_title'); ?>
  Vente de <?php echo e($boite->name); ?>
...
<div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Vente de <?php echo e($boite->name); ?> du <?php echo e(date('d/m/Y', strtotime($boite->date))); ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo e($boite->slug); ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
<?php $__env->stopSection(); ?>

<?php $__currentLoopData = \App\Models\Order::where('cart', $boite->slug)->where('payment_status', true)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="content">
                ...
                <div class="col-12 col-sm-4">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number text-center text-muted mb-0"><?php echo e(count(\App\Models\Order::where('cart', $boite->slug)->where('payment_status', true)->get())); ?></span>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-4">
     ...
     <?php echo e($revenue); ?>€
                ...
                <div class="col-12 col-sm-4">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number text-center text-muted mb-0"><?php echo e(count($boite->products)); ?> <span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-12">
                  <h4>Produit(s) disponible</h4>
                    ...
                    <div class="post">
                      ...
                      <!-- /.user-block -->
                      <p>
                        <?php if(count($boite->products) > 0): ?>
                        <?php $__currentLoopData = $boite->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <ul class="list-unstyled">
                ...
                <li>
                  <a target="_blank" href="<?php echo e(url("manager/ventes/" . $boite->id . "/export-orders")); ?>" class="btn-link text-secondary"><i class="far fa-fw fa-file-pdf"></i> Liste des commandes (texte)</a>
                </li>
                <li>
                  <a target="_blank" href="<?php echo e(url("manager/ventes/" . $boite->id . "/export-orders-mailing-list")); ?>" class="btn-link text-secondary"><i class="far fa-fw fa-envelope"></i> Liste des emails clients</a>
                </li>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              <img height="140px" src="<?php echo e(url("$boite->thumbnail")); ?>" class="img-fluid mb-2 rounded" alt="">
              <h4 class="text-secondary"><i class="fa fa-map-marker"></i> <?php echo e($boite->location_address); ?> <?php echo e($boite->city); ?></h4>
              <h4 class="text-secondary"><i class="fa fa-calendar"></i> <?php echo e($boite->date); ?></h4>
              <p class="text-muted"><?php echo e($boite->description); ?></p>
             
              
             
              <div class="text-center mt-5 mb-3">
                <a href="<?php echo e(url("manager/ventes/$boite->id/edit")); ?>" class="btn btn-sm btn-secondary">Modifier cette vente</a>
...
<!-- Default box -->
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Commandes (<?php echo e(count(\App\Models\Order::where('cart', $boite->slug)->where('payment_status', true)->get())); ?> payées sur <?php echo e(count(\App\Models\Order::where('cart', $boite->slug)->get())); ?> )</h3>
        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped table-responsive">
                ...
                <tbody>
                <?php $__currentLoopData = \App\Models\Order::where('cart', $boite->slug)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td>
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantes-addict/webapp/development/v0.8-latest/resources/views/boitesmanagement/show-boite.blade.php ENDPATH**/ ?>