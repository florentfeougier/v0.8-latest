...
<section class="instagram p-t-0">
  <div class="container animated bounceInUp">
        ...
        <div class="block4 wrap-pic-w p-1 animated slideInUp">
          <div class="block4-square" style="position:relative;width:100%;height:400px; line-height:400px; background:<?php echo e($boite->color_code); ?>;">
            <h3 class="text-center my-auto" style="line-height:400px;" ><?php echo e($boite->name); ?></h3>
          </div>
          <a href="<?php echo e(url("box/$boite->slug")); ?>" class="block4-overlay sizefull ab-t-l trans-0-4">
            ...
            <div class="block4-overlay-txt trans-0-4 p-4">
              <h3 class="text-white"><?php echo e($boite->name); ?></h3>
              <p class="s-text10 m-b-15 h-size1 of-hidden">
                <?php echo e(substr($boite->description, 0, 180)); ?>...
              </p>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantes-addict/webapp/development/v0.8-latest/resources/views/boites/index.blade.php ENDPATH**/ ?>