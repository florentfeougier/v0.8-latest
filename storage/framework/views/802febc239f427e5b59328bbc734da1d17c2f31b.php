<?php $__env->startSection('template_title'); ?>
    Modifier le compte de <?php echo e($user->email); ?>
...
<div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Modifier le compte <?php echo e($user->email); ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            Modifier le compte <?php echo e($user->email); ?>
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florent/Dev/plantesaddict/prod/resources/views/usersmanagement/edit-user.blade.php ENDPATH**/ ?>